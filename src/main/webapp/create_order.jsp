		...
		<div class="content">
			<form action="createorder" method="post">
				<div class="user-details">
					<div class="input-box">
						<span class="details"></span> Encounter ID<input type="text"
							value="<%=request.getParameter("encounterId") %>" name="encounterId"  readonly="readonly">
					</div>
					<div class="input-box">
						<span class="details"></span> Order Date and Time<input type="datetime-local"
