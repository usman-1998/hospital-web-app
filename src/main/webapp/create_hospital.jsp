...
<body>
	<div class="container">
		<div class="title">Create Hospital</div>
		<div class="content">
			<form action="createhospital" method="post">
				<div class="user-details">
					<div class="input-box">
						<span class="details">Hopital Name</span> <input type="text"
							placeholder="Enter Hospital name" name="hospitalName" required>
					</div>

					<div class="input-box">
						<span class="details">Website</span> <input type="text"
							placeholder="Enter website email" name="website" required>
					</div>
					<div class="input-box">
						<span class="details">GST Number</span> <input type="text"
